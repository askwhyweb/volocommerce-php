...
class ApiClient
{
     ...
     */
    public function __construct(\com.volocommerce.api.v1.sdk.invoker\Configuration $config = null)
    {
        if ($config === null) {
     ...
     *
     * @throws \com.volocommerce.api.v1.sdk.invoker\ApiException on a non 2xx response
     * @return mixed
     */
    public function callApi($resourcePath, $method, $queryParams, $postData, $headerParams, $responseType = null, $endpointPath = null)
    {
        ...
        if ($postData and in_array('Content-Type: application/x-www-form-urlencoded', $headers, true)) {
            ...
            $postData = json_encode(\com.volocommerce.api.v1.sdk.invoker\ObjectSerializer::sanitizeForSerialization($postData));
        }
